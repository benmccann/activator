...
//  val sbtLauncherInterface = "org.scala-sbt" % "launcher-interface" % sbtVersion
  ...
  val eclipseSbt13Plugin     =  Defaults.sbtPluginExtra("com.typesafe.sbteclipse" % "sbteclipse-plugin" % eclipseVersion, "0.13", "2.10")
  val ideaSbt13Plugin        =  Defaults.sbtPluginExtra("com.github.mpeltonen" % "sbt-idea" % ideaVersion, "0.13", "2.10")
